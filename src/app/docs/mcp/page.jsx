      ...
      <main className="mx-auto grid max-w-6xl gap-8 px-5 py-10 sm:px-6 lg:grid-cols-[210px_1fr]">
        ...
        <div className="min-w-0 space-y-7">
          ...
          <DocSection id="troubleshooting" title="Troubleshoot server startup">
            ...
            <ol className="list-decimal space-y-3 pl-5">
              <li>In the same terminal that launches the client, run <code className="font-[lixCode] text-accent">node --version</code> and <code className="font-[lixCode] text-accent">command -v npx</code>. LixSketch requires Node.js 20 or newer and an accessible <code className="font-[lixCode] text-accent">npx</code>.</li>
              ...
              <li>If <code className="font-[lixCode] text-accent">npx</code> works in your shell but not in the client, replace <code className="font-[lixCode] text-accent">command = &quot;npx&quot;</code> with the absolute path returned by <code className="font-[lixCode] text-accent">command -v npx</code>.</li>
              <li>For Codex, keep <code className="font-[lixCode] text-accent">startup_timeout_sec = 30</code> in the generated TOML, restart Codex, run <code className="font-[lixCode] text-accent">codex mcp list</code>, and inspect the active session with <code className="font-[lixCode] text-accent">/mcp</code>.</li>
            </ol>
